...
#ifndef SMPPCSVOUTPUTTER_HPP
#define SMPPCSVOUTPUTTER_HPP
...
namespace anthill {
	namespace smpp {
		 ...
		 * A SMPP client 
		 */
		class ANTHILLSMPP_DLLPRFX SMPPCSVOutputter : public SMPPOutputterBase, public anthill::TextOutputter{

		public:
			SMPPCSVOutputter(std::ostream&);
			SMPPCSVOutputter(std::ostream&, const bool bShowEsm);
			SMPPCSVOutputter(std::ostream&, const bool bShowEsm, const bool bShowFmt);
			virtual ~SMPPCSVOutputter();

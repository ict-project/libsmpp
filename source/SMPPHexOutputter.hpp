...
#ifndef SMPPHEXOUTPUTTER_HPP
#define SMPPHEXOUTPUTTER_HPP
...
namespace anthill {
	namespace smpp {
		 ...
		 * A SMPP client 
		 */
		class ANTHILLSMPP_DLLPRFX SMPPHexOutputter : public SMPPOutputterBase, public anthill::TextOutputter{

		public:
			SMPPHexOutputter(std::ostream&);
			virtual ~SMPPHexOutputter();

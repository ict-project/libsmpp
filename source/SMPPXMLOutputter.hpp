...
#ifndef SMPPXMLOUTPUTTER_HPP
#define SMPPXMLOUTPUTTER_HPP
...
namespace anthill {
	namespace smpp {
		 ...
		 * A SMPP client 
		 */
		class ANTHILLSMPP_DLLPRFX SMPPXMLOutputter : public SMPPOutputterBase, public anthill::XMLOutputter{

		public:
			SMPPXMLOutputter(std::ostream&);
			virtual ~SMPPXMLOutputter();
